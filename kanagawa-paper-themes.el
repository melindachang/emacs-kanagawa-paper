;; Original theme by thesimonho. See: https://github.com/thesimonho/kanagawa-paper.nvim

(defgroup kanagawa-paper-themes nil
  "Kanagawa-paper-themes options."
  :group 'faces)

(defcustom kanagawa-paper-themes-comment-italic t
  "Enable italics for comments and also disable background."
  :type 'boolean
  :group 'kanagawa-paper-themes)

(defcustom kanagawa-paper-themes-keyword-italic t
  "Enable italics for keywords."
  :type 'boolean
  :group 'kanagawa-paper-themes)

(defcustom kanagawa-paper-themes-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'kanagawa-paper-themes)

(defcustom kanagawa-paper-themes-org-bold t
  "Inherit text bold for org headings."
  :type 'boolean
  :group 'kanagawa-paper-themes)

(defcustom kanagawa-paper-themes-org-priority-bold t
  "Inherit text bold for priority items in agenda view."
  :type 'boolean
  :group 'kanagawa-paper-themes)

(defcustom kanagawa-paper-themes-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'kanagawa-paper-themes)

;;;###autoload
(defcustom kanagawa-paper-themes-custom-colors '()
  "Place to override default theme colors."
  :type 'list
  :group 'kanagawa-paper-themes)

(eval-when-compile
  (defvar kanagawa-paper-themes-color-palette-list
    '((sumi-ink-n1 "#0f0f15")
      (sumi-ink-0 "#16161D")
      (sumi-ink-1 "#181820")
      (sumi-ink-2 "#1a1a22")
      ...
      (dragon-green-3 "#717e67")
      (dragon-pink "#a292a3")
      (dragon-orange "#b6927b")
      (dragon-orange-2 "#9d7665")
      (dragon-gray "#a6a69c")
      (dragon-gray-2 "#9e9b93")
      (dragon-gray-3 "#7a8382")
      (dragon-blue-2 "#859fac")
      (dragon-blue-3 "#708e9e")
      (dragon-blue-4 "#5d7a88")
      (dragon-blue-5 "#435965")
      ...
      (dragon-black-5-bright "b1afad")
      (dragon-red-bright "#cf8f8b")
      (dragon-green-bright "#779f77")
      (dragon-yellow-bright "#cfc1a1")
      (dragon-blue-5-bright "#6f8e9f")
      (dragon-pink-bright "#b4a7b5")
      (dragon-aqua-bright "#99ada7")
      (old-white-bright "#d3cca8")
      
      (canvas-aqua-1 "#7b958e")
      (canvas-ash-1 "#637263")
      (canvas-blue-1 "#809ba7")
      (canvas-blue-2 "#6b8998")
      (canvas-blue-3 "#577888")
      (canvas-blue-4 "#516e7d")
      (canvas-blue-5 "#3a515e")
      (canvas-cyan-1 "#4a905d")
      (canvas-gray-1 "#aeaea6")
      (canvas-gray-2 "#8e8a80")
      (canvas-gray-3 "#73787d")
      (canvas-green-1 "#7e9579")
      (canvas-green-2 "#7a8c6a")
      (canvas-green-3 "#9ba98e")
      (canvas-orange-1 "#b28d77")
      (canvas-orange-2 "#a8826a")
      (canvas-pink-1 "#9e7e98")
      (canvas-pink-2 "#c1b4c1")
      (canvas-pink-3 "#d4cdd4")
      (canvas-red-1 "#c27672")
      (canvas-teal-1 "#7e8faf")   ;; canvas- primary accent
      (canvas-violet-1 "#7880a5")
      (canvas-violet-2 "#9ba1bf")
      (canvas-yellow-1 "#a7956a")
      (canvas-yellow-2 "#b4a88a")
      (canvas-white-1 "#cbc8bc")
      (canvas-white-2 "#d1cfc5")
      (canvas-white-3 "#d8d8d2")
      (canvas-white-4 "#e1e1de")  ;; canvas- bg
      (canvas-white-5 "#e6e6e3")
      (canvas-white-6 "#ecece8")
...
(eval-and-compile
  (defun kanagawa-paper-themes--variant-colors-symbol (variant)
    "Create symbol for color palette of kanagawa-paper-themes VARIANT."
    (intern (format "kanagawa-paper-themes-%s-colors" (symbol-name variant)))))

(defmacro kanagawa-paper-themes--define-variant-colors (variant &rest body)
  "Define color palette for a specific theme VARIANT via BODY."
  (declare (indent defun))
  `(defvar ,(kanagawa-paper-themes--variant-colors-symbol variant)
     (let ,kanagawa-paper-themes-color-palette-list ,@body)))

(kanagawa-paper-themes--define-variant-colors
 ink
 `((fg ,fuji-white)
   (fg-dim ,dragon-gray-2)
   (fg-dimmer ,dragon-black-5)
   (fg-dark ,dragon-black-3)
   (fg-reverse ,dragon-black-2)
   ...
   (bg-visual ,sumi-ink-5)
   (bg-search ,spring-violet-1)

   (pmenu-fg ,fuji-white)
   (pmenu-fg-sel nil)
   (pmenu-bg ,sumi-ink-4)
   (pmenu-bg-sel ,sumi-ink-5)
   (pmenu-bg-sbar ,sumi-ink-4)
   (pmenu-bg-thumb ,sumi-ink-6)

   (float-fg ,old-white)
   (float-bg ,sumi-ink-4)
   (float-fg-border ,sumi-ink-5)
   (float-bg-border ,sumi-ink-4)
   ...
   (syn-special-1 ,dragon-yellow)
   (syn-special-2 ,dragon-red)
   (syn-special-3 ,spring-violet-1)

   (vcs-added ,dragon-green)
   (vcs-removed ,dragon-red)
   (vcs-changed ,dragon-yellow)

   (diff-add ,dragon-green)
   (diff-delete ,dragon-red)
   (diff-change ,dragon-yellow)
   (diff-text ,dragon-blue)

   (diag-ok ,dragon-green)
   (diag-error ,dragon-red)
   (diag-warning ,dragon-yellow)
   (diag-info ,dragon-blue)
   (diag-hint ,dragon-aqua)

   (black ,dragon-black-5)
   (red ,dragon-red)
   (green ,dragon-green)
   ...
   (cyan ,dragon-aqua)
   (white ,old-white)
   (bright-black ,dragon-black-5-bright)
   (bright-red ,dragon-red-bright)
   (bright-green ,dragon-green-bright)
   (bright-yellow ,dragon-yellow-bright)
   (bright-blue ,dragon-blue-5-bright)
   (bright-magenta ,dragon-pink-bright)
   (bright-cyan ,dragon-aqua-bright)
   (bright-white ,old-white-bright)
   (extend-color-1 ,dragon-orange)
   (extend-color-2 ,dragon-red)))
...
(defmacro kanagawa-paper-themes--face-specs ()
...
;;;;;;; font lock
      ...
      (font-lock-comment-face (:foreground ,syn-comment
                                           :slant ,(if kanagawa-paper-themes-comment-italic 'italic 'normal)))
      ...
      (font-lock-keyword-face (:foreground ,syn-keyword :weight bold
                                           :slant ,(if kanagawa-paper-themes-keyword-italic 'italic 'normal)))
...
;;;;;;; org-mode
      ...
      (org-priority (:foreground ,extend-color-2
                                 :weight ,(if kanagawa-paper-themes-org-priority-bold 'bold 'normal)))
;;;;;; show-paren
...
(defmacro kanagawa-paper-themes--with-variant-colors (variant &rest body)
  "Execute BODY with the color palette of a specified theme VARIANT."
  (declare (indent defun))
  `(let ,(append (symbol-value (kanagawa-paper-themes--variant-colors-symbol variant))
                 kanagawa-paper-themes-custom-colors)
     ,@body))

(defmacro kanagawa-paper-themes--define-theme (variant)
  "Define theme for the kanagawa-paper-themes VARIANT."
  (let ((name (intern (format "kanagawa-paper-%s" (symbol-name variant))))
        (doc (format "The Kanagawa Paper %s theme" variant)))
    `(progn
       (deftheme ,name ,doc)
       (kanagawa-paper-themes--with-variant-colors
         ,variant
         (apply 'custom-theme-set-faces ',name
                (kanagawa-paper-themes--face-specs))
         (provide-theme ',name)))))
...
;;; kanagawa-paper-themes.el ends here
