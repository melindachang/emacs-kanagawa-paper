...
(define-kanagawa-paper-ink-theme
 ...
 `(org-level-3                                   ((,class (:foreground ,dragon-blue-2 :height ,(if kanagawa-paper-theme-org-height 1.2 1.0)))))
 ...
 `(imenu-list-entry-face-0                       ((,class (:foreground ,dragon-red))))
 `(imenu-list-entry-face-1                       ((,class (:foreground ,dragon-violet))))
 `(imenu-list-entry-face-2                       ((,class (:foreground ,dragon-yellow))))
 `(imenu-list-entry-face-3                       ((,class (:foreground ,fuji-white))))
 `(imenu-list-entry-subalist-face-0              ((,class (:foreground ,dragon-red))))
 `(imenu-list-entry-subalist-face-1              ((,class (:foreground ,dragon-violet))))
 `(imenu-list-entry-subalist-face-2              ((,class (:foreground ,dragon-yellow))))
 ...
 `(which-key-group-description-face              ((,class (:foreground ,dragon-red))))
 `(which-key-command-description-face            ((,class (:foreground ,dragon-aqua))))
 `(which-key-local-map-description-face          ((,class (:foreground ,dragon-yellow))))
 `(which-key-posframe                            ((,class (:background ,dragon-blue))))
 `(which-key-posframe-border                     ((,class (:background ,dragon-blue))))

 ;; swiper
 `(swiper-line-face                              ((,class (:foreground ,dragon-yellow))))
 `(swiper-background-match-face-1                ((,class (:background ,dragon-orange :foreground ,dragon-black-2))))
 `(swiper-background-match-face-2                ((,class (:background ,dragon-blue :foreground ,dragon-black-2))))
 `(swiper-background-match-face-3                ((,class (:background ,dragon-yellow :foreground ,dragon-black-2))))
 `(swiper-background-match-face-4                ((,class (:background ,dragon-red :foreground ,dragon-black-2))))
 ...
 ;; rainbow delimiters
 `(rainbow-delimiters-mismatched-face            ((,class (:foreground ,dragon-red))))
 `(rainbow-delimiters-unmatched-face             ((,class (:foreground ,dragon-aqua))))
 `(rainbow-delimiters-base-error-face            ((,class (:foreground ,dragon-red))))
 `(rainbow-delimiters-base-face                  ((,class (:foreground ,dragon-gray-2))))

 `(rainbow-delimiters-depth-1-face               ((,class (:foreground ,spring-violet-1))))
 `(rainbow-delimiters-depth-2-face               ((,class (:foreground ,dragon-blue))))
 `(rainbow-delimiters-depth-3-face               ((,class (:foreground ,dragon-violet))))
 `(rainbow-delimiters-depth-4-face               ((,class (:foreground ,dragon-green))))
 `(rainbow-delimiters-depth-5-face               ((,class (:foreground ,dragon-aqua))))
 `(rainbow-delimiters-depth-6-face               ((,class (:foreground ,dragon-yellow))))
 `(rainbow-delimiters-depth-7-face               ((,class (:foreground ,dragon-red))))
 `(rainbow-delimiters-depth-8-face               ((,class (:foreground ,dragon-blue-2))))
 `(rainbow-delimiters-depth-9-face               ((,class (:foreground ,spring-violet-1))))

 ;; show-paren
 `(show-paren-match                              ((,class (:background ,dragon-aqua :foreground ,dragon-black-2 :weight bold :underline ,(when kanagawa-paper-theme-underline-parens t)))))
 `(show-paren-match-expression                   ((,class (:background ,dragon-aqua :foreground ,dragon-black-2 :weight bold))))
 `(show-paren-mismatch                           ((,class (:background ,dragon-red :foreground ,old-white :underline ,(when kanagawa-paper-theme-underline-parens t)))))
 `(tooltip                                       ((,class (:foreground ,fuji-white :background ,sumi-ink-4 :weight bold))))
 ...
 `(company-scrollbar-fg                          ((,class (:background ,sumi-ink-4))))
 `(company-preview                               ((,class (:foreground ,dragon-yellow))))
 `(company-preview-common                        ((,class (:foreground ,dragon-red :weight bold))))
 ...
 `(flycheck-posframe-info-face                   ((,class (:background ,sumi-ink-0 :foreground ,dragon-blue))))
 `(flycheck-posframe-warning-face                ((,class (:background ,sumi-ink-0 :foreground ,dragon-yellow))))
 `(flycheck-posframe-error-face                  ((,class (:background ,sumi-ink-0 :foreground ,dragon-red))))
 `(flycheck-fringe-warning                       ((,class (:foreground ,dragon-yellow))))
 `(flycheck-fringe-error                         ((,class (:foreground ,dragon-red))))
 `(flycheck-fringe-info                          ((,class (:foreground ,dragon-blue))))
 `(flycheck-error-list-warning                   ((,class (:foreground ,dragon-yellow :weight bold))))
 `(flycheck-error-list-error                     ((,class (:foreground ,dragon-red :weight bold))))
 `(flycheck-error-list-info                      ((,class (:foreground ,dragon-blue :weight bold))))
 `(flycheck-inline-error                         ((,class (:foreground ,dragon-black-2 :background ,dragon-red :slant italic :weight bold))))
 `(flycheck-inline-warning                       ((,class (:foreground ,dragon-black-2 :background ,dragon-yellow :slant italic :weight bold))))
 `(flycheck-inline-info                          ((,class (:foreground ,dragon-black-2 :background ,dragon-blue :weight bold))))
 ...
 ;; term
 `(term                                          ((,class (:background ,sumi-ink-3 :foreground ,fuji-white))))
 `(term-color-blue                               ((,class (:background ,dragon-blue-5 :foreground ,dragon-blue-5))))
 `(term-color-bright-blue                        ((,class (:inherit term-color-blue))))
 `(term-color-green                              ((,class (:background ,dragon-green :foreground ,dragon-green))))
 `(term-color-bright-green                       ((,class (:inherit term-color-green))))
 `(term-color-black                              ((,class (:background ,dragon-black-5 :foreground ,fuji-white))))
 ;; NOTE - has effect on vterm as well so vterm specific settings bellow doesn't do much.
 `(term-color-bright-black                       ((,class (:background ,sumi-ink-5 :foreground ,fuji-gray))))
 ...
 `(term-color-red                                ((,class (:background ,dragon-red :foreground ,dragon-red))))
 `(term-color-bright-red                         ((,class (:background ,dragon-red :foreground ,dragon-red))))
 ...
 `(term-color-cyan                               ((,class (:background ,dragon-aqua :foreground ,dragon-aqua))))
 `(term-color-bright-cyan                        ((,class (:background ,dragon-aqua :foreground ,dragon-aqua))))
 `(term-color-magenta                            ((,class (:background ,dragon-pink :foreground ,dragon-pink))))
 `(term-color-bright-magenta                     ((,class (:background ,dragon-pink :foreground ,dragon-pink))))
 ;; vterm
 `(vterm-color-black                             ((,class (:background ,dragon-black-5 :foreground ,dragon-violet))))
 `(vterm-color-underline                         ((,class (:foreground ,fuji-white))))
 `(vterm-color-inverse-video                     ((,class (:background ,dragon-black-5 :inverse-video t))))
 ...
 `(tab-bar-tab                                   ((,class (:background ,sumi-ink-3 :foreground ,dragon-white))))
 `(tab-bar-tab-inactive                          ((,class (:background ,sumi-ink-0 :foreground ,dragon-black-5))))
 ...
 `(git-gutter:added                              ((,class (:foreground ,dragon-green))))
 `(git-gutter:deleted                            ((,class (:foreground ,dragon-red))))
 ...
 `(ansi-color-green                              ((,class (:foreground ,dragon-green))))
 `(ansi-color-black                              ((,class (:background ,dragon-black-5))))
 `(ansi-color-cyan                               ((,class (:foreground ,dragon-aqua))))
 `(ansi-color-magenta                            ((,class (:foreground ,dragon-pink))))
 `(ansi-color-blue                               ((,class (:foreground ,dragon-blue-5))))
 `(ansi-color-red                                ((,class (:foreground ,dragon-red))))
 `(ansi-color-white                              ((,class (:foreground ,fuji-white))))
 `(ansi-color-yellow                             ((,class (:foreground ,dragon-yellow))))
 `(ansi-color-bright-white                       ((,class (:foreground ,old-white))))

 `(tree-sitter-hl-face:attribute                 ((,class (:foreground ,dragon-yellow))))
 `(tree-sitter-hl-face:escape                    ((,class (:foreground ,dragon-red))))
 `(tree-sitter-hl-face:constructor               ((,class (:foreground ,dragon-aqua :weight semi-bold))))

 ;; `(tree-sitter-hl-face:constant                  ((,class (:foreground ,dragon-orange))))
 ;; `(tree-sitter-hl-face:constant.builtin          ((,class (:foreground ,dragon-orange :weight semi-bold))))

 ;; `(tree-sitter-hl-face:embedded                  ((,class (:foreground ,dragon-yellow))))
 ...
 `(tree-sitter-hl-face:variable.synthesized      ((,class (:foreground ,dragon-blue-2))))

 `(tree-sitter-hl-face:number                    ((,class (:foreground ,dragon-pink))))
 `(tree-sitter-hl-face:operator                  ((,class (:foreground ,dragon-red :weight bold))))

 `(tree-sitter-hl-face:punctuation               ((,class (:foreground ,dragon-gray-2))))
 `(tree-sitter-hl-face:punctuation.bracket       ((,class (:foreground ,dragon-gray-2))))
 `(tree-sitter-hl-face:punctuation.delimiter     ((,class (:foreground ,dragon-gray-2))))
 `(tree-sitter-hl-face:punctuation.special       ((,class (:foreground ,dragon-red))))

 `(tree-sitter-hl-face:case-pattern              ((,class (:foreground ,dragon-red))))
 `(tree-sitter-hl-face:keyword.compiler          ((,class (:foreground ,dragon-red :slant italic))))
